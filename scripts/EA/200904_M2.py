...
if __name__ == '__main__':
    ...
    model_fxns = model.Model(model.M2_kb, model.simulate_t100a_experiment_M2_kb, model.simulate_nopos_experiment_M2a_kb, model.M2c_kb_on_off)
