...
def scorefxn_helper(individual):
    ...
    return model_supp.calc_sim_score(model_fxns, exp_data, exp_time, total_protein, inits, individual, ptpD=True, convert=(True, arr_conversion_matrix)),
...
if __name__ == '__main__':
    ...
    save_filename = '200929_M3_ptp.txt'
