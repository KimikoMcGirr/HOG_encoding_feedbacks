...
if __name__ == '__main__':
    ...
    model_fxn = model.Model(model.M1a_kb, model.simulate_t100a_experiment_M1a_kb)
    save_filename = '200123_kb_M1a_ea_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('/pine/scr/s/k/sksuzuki/HOG_model/paper/200107_kb_M1a/', number_eas, particle_num)
