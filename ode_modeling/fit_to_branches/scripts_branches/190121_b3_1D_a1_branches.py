...
filename = 'b23_1D_a1_map2k_branches_190121.txt'
...
def a1_1D_branched(inits,t,params_constants,params):
    ...
    beta_sho1, beta_sln1, alpha_1, k1, k3, ksho1, ksln1, k7, s9, k2, k4, k6, k8, d10, K_1, K_3, K_sho1, K_sln1, K_7, K_2, K_4, K_6, K_8 = params #22
    ...
    dSho1 = (s/(1+X/beta_sho1)) * (((k1)*Sho1_I)/(K_1+Sho1_I)) - (k2*Sho1/(K_2+Sho1))
    dSln1 = (s/(1+X/beta_sln1)) * (((k3)*Sln1_I)/(K_3+Sln1_I)) - (k4*Sln1/(K_4+Sln1))
...
def simulate_t100a_experiment(inits, params_constants, learned_params, time):
    ...
    # parameters to be kept constant - params_constants
    # parameters to be learned - learned_params
    beta_sho1, beta_sln1, alpha_1, k1, k3, ksho1, ksln1, k7, s9, k2, k4, k6, k8, d10, K_1, K_3, K_sho1, K_sln1, K_7, K_2, K_4, K_6, K_8  = learned_params
    learned_params = beta_sho1, beta_sln1, 0, k1, k3, ksho1, ksln1, k7, 0, k2, k4, k6, k8, d10, K_1, K_3, K_sho1, K_sln1, K_7, K_2, K_4, K_6, K_8
    #solve odes:
    odes = odeint(a1_1D_branched, inits, time, args=(params_constants, learned_params))
