...
if __name__ == '__main__':
    ...
    params_constants = [MAP3K_t, MAP2K_t, MAPK_t, 550000*2, PTP_t] #uM, except for gly (1) which is a placeholder for multiplying arrays together

    model_fxn = model.Model(model.M4, model.simulate_t100a_experiment_M4, model.M4_nopos)
    save_filename = '200213_kb_M4_ea_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('/pine/scr/s/k/sksuzuki/HOG_model/paper/190926_kb_M4_long/', number_eas, particle_num)
