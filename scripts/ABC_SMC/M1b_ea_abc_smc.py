...
if __name__ == '__main__':
    ...
    model_fxn = model.Model(model.M1b, model.run_ss, model.simulate_wt_experiment, t100a=model.simulate_t100a_experiment_M1a)
    save_filename = '200914_M1b_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('../../sim_data/EA/200914_M1b/', number_eas, particle_num)
