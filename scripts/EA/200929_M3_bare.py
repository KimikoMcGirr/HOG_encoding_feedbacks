...
def scorefxn_helper(individual):
    ...
    return model_supp.calc_sim_score_original(model_fxns, exp_data, exp_time, total_protein, inits, individual, ptpD=True, convert=(True, arr_conversion_matrix)),
...
if __name__ == '__main__':
    ...
    save_filename = '200929_M3_bare.txt'
    ...
    model_fxns = model.Model(model.M3, model.run_ss, model.simulate_wt_experiment, model.simulate_t100a_experiment_M3)
