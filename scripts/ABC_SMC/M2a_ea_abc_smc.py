...
if __name__ == '__main__':
    ...
    model_fxn = model.Model(model.M2a_kb, model.simulate_t100a_experiment_M2a_kb, model.simulate_nopos_experiment_M2a_kb)
    save_filename = '200904_M2a_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('../EA/200904_M2a/', number_eas, particle_num)
