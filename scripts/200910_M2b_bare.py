...
def scorefxn_helper(individual):
    ...
    return model_supp.calc_sim_score_original(model_fxns, exp_data, exp_time, total_protein, inits, individual, ptpD=False, convert=(True, arr_conversion_matrix)),
...
if __name__ == '__main__':
    ...
    save_filename = '200910_M2b_bare.txt'
    ...
    model_fxns = model.Model(model.M2b_kb, model.simulate_t100a_experiment_M2a_kb)
