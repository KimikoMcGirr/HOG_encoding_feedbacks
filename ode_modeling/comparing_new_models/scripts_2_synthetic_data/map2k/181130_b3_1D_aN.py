...
filename = 'b3_1D_aN_map2k_SYNTH.pickled'
...
mapk_time, scorefxn_data = scorefxn_arr

filename = '181130_b3_1D_aN_map2k_SYNTH.txt'
...
def b3_aN_1D_X(initals,t,params_constants,params):
    ...
    dMAPK = (((k5*MAP2K)*MAPK_I)/(K_5+MAPK_I)) - (k6*MAPK/(K_6+MAPK)) #k7/1+MAPK/k2)
    dX = s7*MAPK - d8*X
...
def scorefxn1(scorefxn_data, inits, params_constants,
    ...
    for sig, MAPK_wt_data, MAPK_t100a_data, MAP2K_wt_data, MAP2K_t100a_data in zip(params_constants[-1],
                                                                                    scorefxn_data[0],
                                                                                    scorefxn_data[1],
                                                                                    scorefxn_data[2],
                                                                                    scorefxn_data[3]):
