...
filename = 'b3_1D_a3_map2k_branches_190111.txt'
...
def a3_1D_branches(inits,t,params_constants,params):
    Sho1, Sln1, Pbs2, Hog1, X = inits
    Sho1_t, Sln1_t, Pbs2_t, Hog1_t, sho1_on, sln1_on, s = params_constants
    beta_s, alpha_3, k1, k3, ksho1, ksln1, k7, s9, k2, k4, k6, k8, d10, K_1, K_3, K_sho1, K_sln1, K_7, K_2, K_4, K_6, K_8 = params #22
    ...
    dSho1 = (s/(1+X/beta_s)) * (((k1+alpha_3*Hog1)*Sho1_I)/(K_1+Sho1_I)) - (k2*Sho1/(K_2+Sho1))
    dSln1 = (s/(1+X/beta_s)) * (((k3+alpha_3*Hog1)*Sln1_I)/(K_3+Sln1_I)) - (k4*Sln1/(K_4+Sln1))
...
def simulate_wt_experiment(inits, params_constants, learned_params, time):
    ...
    #solve odes:
    odes = odeint(a3_1D_branches, inits, time, args=(params_constants, learned_params))
...
def simulate_t100a_experiment(inits, params_constants, learned_params, time):
    ...
    # parameters to be kept constant - params_constants
    # parameters to be learned - learned_params
    beta_s, alpha_3, k1, k3, ksho1, ksln1, k7, s9, k2, k4, k6, k8, d10, K_1, K_3, K_sho1, K_sln1, K_7, K_2, K_4, K_6, K_8  = learned_params
...
def simulate_sho1_branch(inits, params_constants, learned_params, time):
    ...
    odes = odeint(a3_1D_branched, inits, time, args=(params_constants, learned_params))
    return odes
