...
filename = '181129_b3_1D_a1neg.pickled'
...
#
# filename = '181112_b3_1D_a1_map2k_SYNTH.txt'
...
def b3_a1_1D_X(initals,t,params_constants,params):
    ...
    dMAPK = (((k5*MAP2K)*MAPK_I)/(K_5+MAPK_I)) - (1/(1+MAPK/alpha_1))**fb *(k6*MAPK/(K_6+MAPK))
    dX = s7*MAPK - d8*X
...
def simulate_t100a_experiment(inits, params_constants, learned_params, time):
    ...
    learned_params = beta_3, alpha_1, k1, k3, k5, 0, k2, k4, k6, d8, K_1, K_3, K_5, K_2, K_4, K_6
    #solve odes:
    odes = odeint(b3_a1_1D_X, inits, time, args=(params_constants, learned_params))
