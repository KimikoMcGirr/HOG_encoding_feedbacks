...
def run_schedule_i(prior_thetas, ei, num_theta_primes, model_fxns, step):
    ...
    while len(thetas_ei) < num_theta_primes:
        ...
        theta_prime = step_theta(theta, step)
...
def main(f, number_eas, particle_num):
    ...
    for i, ei in enumerate(eis):
        ...
        ABC_SMC_mses, ABC_SMC_thetas, ABC_SMC_c = run_schedule_i(prior_thetas, ei, particle_num, model_fxn, i)
        print(ABC_SMC_c)
...
if __name__ == '__main__':
    ...
    model_fxn = model.Model(model.M2b, model.run_ss, model.simulate_wt_experiment, model.simulate_t100a_experiment_M2a)
    save_filename = '200910_M2b_bare_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('../../sim_data/EA/200910_M2b_bare/', number_eas, particle_num)
