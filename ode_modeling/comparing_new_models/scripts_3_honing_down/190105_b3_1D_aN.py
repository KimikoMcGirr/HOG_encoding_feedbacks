...
def b3_1D_aN(initals,t,params_constants,params):
    ...
    dMAP3K = (s/(1+X/beta_3))**fb * (((k1)*MAP3K_I)/(K_1+MAP3K_I)) - (k2*MAP3K/(K_2+MAP3K))
...
def simulate_wt_experiment(inits, params_constants, learned_params, time):
    ...
    #solve odes:
    odes = odeint(b3_1D_aN, inits, time, args=(params_constants, learned_params))
