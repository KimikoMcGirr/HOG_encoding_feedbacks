...
if __name__ == '__main__':
    ...
    model_fxn = model.Model(model.M1, model.run_ss, model.simulate_wt_experiment, t100a=model.simulate_t100a_experiment_M1)
    save_filename = '200914_M1_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('../EA/200914_M1/', number_eas, particle_num)
