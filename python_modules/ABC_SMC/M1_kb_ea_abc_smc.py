...
if __name__ == '__main__':
    ...
    model_fxn = model.Model(model.M1_kb, model.simulate_t100a_experiment_M1)
    save_filename = '200123_kb_M1_ea_abc_smc.txt'
    number_eas = 500
    particle_num = 1000
    main('/pine/scr/s/k/sksuzuki/HOG_model/paper/190924_kb_M1/', number_eas, particle_num)
