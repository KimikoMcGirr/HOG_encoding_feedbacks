...
def main(files, number_eas, particle_num, model_fxns):
...
# define model functions
    ...
    # model_fxn = model.Model(model.M2_kb, model.simulate_t100a_experiment_M2_kb, model.simulate_nopos_experiment_M2a_kb)
    model_fxn1 = model.Model(model.M2b_kb, model.simulate_t100a_experiment_M2a_kb, model.simulate_nopos_experiment_M2a_kb)
    model_fxn2 = model.Model(model.M2c_kb, model.simulate_t100a_experiment_M2a_kb, model.simulate_nopos_experiment_M2a_kb)

    model_fxns = [model_fxn1, model_fxn2]
    save_filename = 't200124_M2b-M2c_model_selection.txt'
    number_eas = 500
    particle_num = 1000
    # main('/pine/scr/s/k/sksuzuki/HOG_model/paper/190924_kb_M2/', number_eas, particle_num)
    main(['C:/Users/sksuzuki/Desktop/killdevil/runs_for_paper/191205_kb_M2b/', 'C:/Users/sksuzuki/Desktop/killdevil/runs_for_paper/191205_kb_M2c/'], number_eas, particle_num, model_fxns)
