...
save_filename = '190218_all_fbs_pulse.txt'
...
experiment_data = {0 : [mapk_t100a_data[0]],
                    50000 : [mapk_t100a_data[1]],
                    150000 : [mapk_t100a_data[2]],# map2k_wt_data[0], map2k_t100a_data[0]],
                    250000 : [mapk_t100a_data[3]],
                    350000 : [mapk_t100a_data[4]],
                    450000 : [mapk_t100a_data[5]],
                    550000 : [mapk_t100a_data[6]]
    }
...
def b321_a31_1D(initals,t,total_protein,sig,params, signal_fxn=None, signal_params=None):
    MAP3K, MAP2K, MAPK, X = initals
    MAP3K_t, MAP2K_t, MAPK_t = total_protein
    beta_3, beta_2, alpha_3, alpha_1, k1, k3, k5, s7, k2, k4, k6, d8, K_1, K_3, K_5, K_2, K_4, K_6 = params
    ...
    dMAP3K = (sig/(1+X/beta_3)) * (((k1+alpha_3*MAP2K)*MAP3K_I)/(K_1+MAP3K_I)) - ((k2+beta_2*MAP2K)*MAP3K/(K_2+MAP3K))
...
#
#     #solve odes:
#     odes = odeint(b321_a31_1D, inits, time, args=(total_protein, sig, learned_params, signal_fxn, signal_params))
#
#     return odes
...
def simulate_t100a_experiment(inits, total_protein, sig, learned_params, time, signal_fxn, signal_params):
    ...
    # parameters to be kept constant - params_constants
    # parameters to be learned - learned_params
    beta_3, beta_2, alpha_3, alpha_2, k1, k3, k5, s7, k2, k4, k6, d8, K_1, K_3, K_5, K_2, K_4, K_6  = learned_params
    learned_params = beta_3, beta_2, alpha_3, 0, k1, k3, k5, 0, k2, k4, k6, d8, K_1, K_3, K_5, K_2, K_4, K_6
    #solve odes:
    odes = odeint(b321_a31_1D, inits, time, args=(total_protein, sig, learned_params, signal_fxn, signal_params))
...
def scorefxn1(experiment_data, inits, total_protein,
    ...
    for dose in experiment_doses:
        ...
        data = simulate_t100a_experiment(inits, total_protein, dose, arr_params_IP, exp_time[0], None, None)
        mapk = data[:,2]/total_protein[2]*100
        error_active = ((exp_data - mapk)**2).mean()
        ...
        #     mapk = data[:,2]/total_protein[2]*100
        #     error_active = ((exp_data[2] - mapk)**2).mean()
        #     mse_total += error_active
