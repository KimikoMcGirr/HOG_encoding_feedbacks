...
save_filename = '190122_1D_aN_map2k_pulse.txt'
...
experiment_data = {0 : [mapk_wt_data[0], mapk_t100a_data[0]],
                    ...
                    550000 : [mapk_wt_data[6], mapk_t100a_data[6], map2k_wt_data[1], map2k_t100a_data[1], mapk_pulse_data, map2k_pulse_data]
    }
...
total_protein = [MAP3K_t, MAP2K_t, MAPK_t, fb] #uM
...
def b3_aN_1D_X(initals,t,total_protein,sig,params, signal_fxn=None, signal_params=None):
    ...
    dMAP3K = (sig/(1+X/beta_3)**fb) * (((k1)*MAP3K_I)/(K_1+MAP3K_I)) - (k2*MAP3K/(K_2+MAP3K))
